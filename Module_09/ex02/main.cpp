...
/**
 * @brief Returns true if the container is sorted.
 * 
...
/**
 * @brief Compares the number of comparisons made with the estimated worst case.
 * 
 * @param actualComparisons The actual number of comparisons made.
 * @param n The size of the input data.
 * @return True if the actual comparisons are within the expected limit.
 */
...
/**
 * @brief Main function to implement the Ford-Johnson algorithm with vector and deque.
 * 
 * @details Parses, sorts, and outputs raw data and benchmark analysis.
 */
int main(int argc, char* argv[]) {
    ...
    /**
     * @brief Parse command line arguments and check for valid integers.
     */
    ...
    /**
    * @brief Sort using 1st container: VECTOR
    */
    ...
    std::cout << std::fixed << std::setprecision(2) << YELLOW << std::setw(20) << "Vector Overall time:\t" << std::setw(8)
              << timingVector.getOverallDuration() << " us\t" << RESET << std::setw(20) << "[ Pairing Sort time: " << std::setw(8)
              << timingVector.getPairingDuration() << " us ]\t" << std::setw(20) << "[ MergeSort time: " << std::setw(8)
              << timingVector.getMergeSortDuration() << " us ]\t" << std::setw(20) << "[ BinaryInsertion time: " << std::setw(8)
              << timingVector.getBinaryInsertDuration() << " us ]\n";
    ...
    */
    ...
    std::cout << std::fixed << std::setprecision(2) << YELLOW << std::setw(20) << "Deque Overall time:\t" << std::setw(8)
              << timingDeque.getOverallDuration() << " us\t" << RESET << std::setw(20) << "[ Pairing Sort time: " << std::setw(8)
              << timingDeque.getPairingDuration() << " us ]\t" << std::setw(20) << "[ MergeSort time: " << std::setw(8)
              << timingDeque.getMergeSortDuration() << " us ]\t" << std::setw(20) << "[ BinaryInsertion time: " << std::setw(8)
              << timingDeque.getBinaryInsertDuration() << " us ]\n";

    /**
     * @brief Fastest container assessment.
     * Compares overall time spent and detailed single step timing.
     */
    std::cout << CYAN << "\n---- Fastest container ----\n" << RESET;
    if (timingVector.getOverallDuration() <= timingDeque.getOverallDuration()) {
        ...
        std::cout << std::fixed << std::setprecision(2) << GREEN << "Vector fastest by:\t" << std::setw(8) << speedupOverall << " % \t"
                  << RESET << std::setw(20) << "[ Pairing: " << std::setw(8) << speedupPairing << " % ]\t" << std::setw(20)
                  << "[ MergeSort:" << std::setw(8) << speedupMergeSort << " % ]\t" << std::setw(20)
                  << "[ BinaryInsertion: " << std::setw(8) << speedupBinaryInsert << " % ]\n";
    } else {
        ...
        std::cout << std::fixed << std::setprecision(2) << GREEN << "Deque fastest by:\t" << std::setw(8) << speedupOverall << " % \t"
                  << RESET << std::setw(20) << "[ Pairing: " << std::setw(8) << speedupPairing << " % ]\t" << std::setw(20)
                  << "[ MergeSort:" << std::setw(8) << speedupMergeSort << " % ]\t" << std::setw(20)
                  << "[ BinaryInsertion: " << std::setw(8) << speedupBinaryInsert << " % ]\n";
    }
    /**
     * @brief Ford and Johnson comparison, expected (< n log n) vs practice.
     */
    if (contextVector.comparisons == contextDeque.comparisons) {
        std::cout << CYAN << "\n----- Ford and Johnson comparison, expected (< n log n) vs practice ----" << RESET;
