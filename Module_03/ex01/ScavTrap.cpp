...
ScavTrap& ScavTrap::operator=(const ScavTrap& other) {
    ...
    if (this != &other) {
        ...
        // Additional assignment for derived class members, if any
        ...
        std::cout << RED << "⚠️  ScavTrap ⚠️  class operator assignment failed: explicitely assigning value of variable to itself";
